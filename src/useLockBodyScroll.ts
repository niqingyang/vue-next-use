...
export default !doc
    ? function useLockBodyMock(_locked: boolean | Ref<boolean> = true, _elementRef?: Ref<HTMLElement>) {
    }
    : function useLockBody(locked: boolean | Ref<boolean> = true, elementRef?: Ref<HTMLElement>) {
